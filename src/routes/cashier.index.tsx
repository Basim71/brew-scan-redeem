...
import { Coffee, Check, X, RefreshCw, Loader2 } from "lucide-react";
...
function CashierDashboard() {
  ...
  if (!branchId) {
    return (
      <div className="panel-warm p-8 max-w-md text-center mx-auto">
  ...
  return (
    <div>
      <div className="flex justify-end mb-4">
        <button onClick={load} className="btn-ghost-brass px-3 py-2"><RefreshCw className={"w-4 h-4 " + (loading ? "animate-spin" : "")} /></button>
      </div>
