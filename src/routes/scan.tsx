          ...
          <div className="space-y-4">
            <div className="panel-warm p-6">
              ...
              <p className="mt-2 text-center text-sm text-cream-dim">
                {lang === "ar"
                  ? "يمكنك مشاهدة المشروبات الآن، ويتطلب الطلب اشتراكًا فعالًا."
                  : "You can view the drinks now. Ordering requires an active subscription."}
              </p>
            </div>
                ...
                {drinks.map(
                  (drink) => (
                    <div
                      ...
                      className="engraved p-4 text-center"
                    >
                      <Coffee className="mx-auto mb-3 h-7 w-7 text-caramel-bright" />
        ...
        {step === "menu" &&
          ...
          <>
            ...
            <div className="panel p-6">
                ...
                {drinks.map(
                  (drink) => (
                    <button
                      ...
                      className="engraved p-4 text-center transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-40"
                    >
                      <Coffee className="mx-auto mb-2 h-6 w-6 text-caramel-bright" />
              ...
              {drinks.length ===
                0 && (
                <div className="engraved mt-4 p-4 text-center text-sm text-cream-dim">
                  {lang === "ar"
                    ? "لا توجد مشروبات متاحة."
                    : "No drinks are available."}
                </div>
              )}
