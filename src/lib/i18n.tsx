...
const dict = {
  en: {
    ...
    // sell coupon
    sell_title: "Sell coupon",
    sell_subtitle: "Assign a coupon to a customer",
    sell_field_coupon: "Available coupon",
    sell_field_customer: "Customer name",
    sell_field_phone: "Phone number",
    sell_field_start: "Start date",
    sell_pick_coupon: "Choose a coupon",
    sell_no_available: "No available coupons.",
    sell_field_branch: "Branch",
    sell_pick_branch: "Choose a branch",
    sell_err_coupon: "Please select an available coupon.",
    sell_err_customer: "Customer name is required.",
    sell_err_phone: "Phone must start with 05 and be exactly 10 digits.",
    sell_err_start: "Start date is required.",
    sell_err_branch: "Please select a branch for this coupon.",
    sell_success: "Coupon sold. Subscription created.",
    sell_btn: "Sell",
    sell_active_title: "Active subscription found",
    sell_active_body: "This phone number already has an active subscription. Do you want to add another one?",
    sell_add_another: "Add another",
    sell_phone_hint: "Saudi format: 05XXXXXXXX",
  ...
  ar: {
    ...
    sell_title: "بيع كوبون",
    sell_subtitle: "إسناد كوبون إلى عميل",
    sell_field_coupon: "الكوبون المتاح",
    sell_field_customer: "اسم العميل",
    sell_field_phone: "رقم الهاتف",
    sell_field_start: "تاريخ البدء",
    sell_pick_coupon: "اختر كوبوناً",
    sell_no_available: "لا توجد كوبونات متاحة.",
    sell_field_branch: "الفرع",
    sell_pick_branch: "اختر الفرع",
    sell_err_coupon: "الرجاء اختيار كوبون متاح.",
    sell_err_customer: "اسم العميل مطلوب.",
    sell_err_phone: "الرقم يجب أن يبدأ بـ 05 ويتكوّن من 10 أرقام.",
    sell_err_start: "تاريخ البدء مطلوب.",
    sell_err_branch: "الرجاء اختيار فرع لهذا الكوبون.",
    sell_success: "تم بيع الكوبون وإنشاء الاشتراك.",
    sell_btn: "بيع",
    sell_active_title: "يوجد اشتراك نشط",
    sell_active_body: "هذا الرقم لديه اشتراك نشط بالفعل. هل تريد إضافة اشتراك آخر؟",
    sell_add_another: "إضافة اشتراك",
    sell_phone_hint: "الصيغة السعودية: 05XXXXXXXX",
